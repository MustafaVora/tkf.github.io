...
function loadFrames(containerId, limit = products.length) {
...
// Load frames on home page and collections page
loadFrames("home-grid", 4);       // Show 4 featured frames on homepage
loadFrames("productGrid", 12);    // Show all 12 frames on collections page
